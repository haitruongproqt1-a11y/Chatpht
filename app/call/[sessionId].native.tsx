...
export default function CallScreen() {
  ...
  if (error || call.error) return <CallBlocked title="Chưa thể vào cuộc gọi" copy={error ?? call.error ?? "Lỗi không xác định."} />;
